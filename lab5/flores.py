...
def name_to_flores_200_code(name):
    ...
    for long_name in long_names:
        if lower_name == long_name.lower():
            return FLORES_200_MAP[long_name]
          
    # Match against the first part of the name.
    for long_name in long_names:
        long_name_parts = long_name.split(" ")
        if lower_name == long_name_parts[0].lower():
            return FLORES_200_MAP[long_name]

    # Match against any part of the name.
    for long_name in long_names:
        long_name_parts = long_name.split(" ")[1:]
        for part in long_name_parts:
            if lower_name == part.lower():
                return FLORES_200_MAP[long_name]
